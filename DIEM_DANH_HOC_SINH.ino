...
const char* ssid = "Mechanic";  //--> Your wifi name
const char* password = "01052003ad";
// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbzH3F-6kUZy5vwUk38OyosDglU6IT8YScft4FbXV3OOGpaebN_ZPZo_3QOR6fLxuDNyCg/exec";
